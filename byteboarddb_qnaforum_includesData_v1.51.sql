...
INSERT INTO `comments` VALUES (1,1,2,NULL,'I don\'t think this is useful. OP made this question and self-answer to document how to get the response from async calls. Suggesting a 3rd party module defeats such purpose, and IMO the paradigm introduced by that module is not good practice.',0),(2,2,NULL,3,'Also, the official documentation of mysql_query only allows to execute one query, so any other query besides ; is ignored. Even if this is already deprecated there are a lot of systems under PHP 5.5.0 and that may use this function.',2),(4,4,NULL,3,'Lacks explanation of what is prepared statement; it\'s a performance hit if used lot of prepared statements during request and sometimes accounts for 10x performance hit. Better case would be use PDO with parameter binding off,but statement preparation off',0),(5,2,NULL,5,'I think \"some error constant\" is more correct than \"The Epsilon\" because there is no \"The Epsilon\" which could be used in all cases. Different epsilons need to be used in different situations. And the machine epsilon is almost never a good constant to use',3),(6,1,4,NULL,'Floating point variables typically have this behaviour. It\'s caused by how they are stored in hardware. For more info check out the Wikipedia article on floating point numbers.',1),(7,3,4,NULL,'Just for information, ALL numeric types in javascript are IEEE-754 Doubles',0);
...
INSERT INTO `qna_comments_feedback` VALUES (1,1,2,0),(2,2,3,1),(3,2,1,1),(4,2,4,0),(5,5,1,1),(6,5,4,1),(7,6,4,1),(8,6,3,0),(9,5,3,1);
...
INSERT INTO `qna_tags` VALUES (1,'java'),(2,'nullPointerException'),(3,'exception'),(4,'javascript'),(5,'ajax'),(6,'asynchronous'),(7,'php'),(8,'mysql'),(9,'security'),(10,'sqlInjection'),(11,'math'),(12,'floatingPoint'),(13,'precision');
...
INSERT INTO `qna_users` VALUES (1,'Advaitya','$2a$10$ExC3XhxZq6uS3ADLJPka6eyFk8On6vWnClVFf96DhChyJnZuLU1Ra','advaitya@gmail.com',3,2),(2,'Vinayak','$2a$10$FudfzJf0ruBZQGLJmVQDGu8K5oonNpknfBwEpqsYRvYQG7zaI5UV2','vinayak@gmail.com',5,1),(3,'Meghan','$2a$10$QbgZB2ECYtprjiHo8g4wN.aO5SM87E07aeFtOOJL2w/NrG7eyznSK','meghan@gmail.com',2,7),(4,'Nishant','$2a$10$x2gqLVg3M99ePMvpGOlBlOou4R6puaaroRn0T4VMd2BHzhZR8FhqG','nishant@gmail.com',4,3);
...
INSERT INTO `qna_votes` VALUES (1,2,1,NULL,'up'),(2,1,NULL,2,'up'),(3,1,2,NULL,'down'),(4,2,NULL,2,'up'),(5,3,2,NULL,'up'),(6,1,3,NULL,'up'),(7,2,3,NULL,'up'),(8,2,NULL,3,'up'),(9,3,NULL,3,'up'),(10,4,2,NULL,'up'),(11,4,NULL,3,'down'),(12,2,NULL,5,'up'),(13,2,4,NULL,'up'),(14,1,4,NULL,'up'),(15,1,NULL,5,'up'),(16,4,NULL,5,'up'),(17,3,4,NULL,'up');
...
INSERT INTO `question_tags` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,2),(5,5,2),(6,6,2),(7,7,3),(8,8,3),(9,9,3),(10,10,3),(11,11,4),(12,12,4),(13,13,4);
...
-- Dump completed on 2024-10-05  1:54:38
